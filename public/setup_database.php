...
try {
    ...
    $db->exec("CREATE TABLE IF NOT EXISTS notifications (
        ...
        bet_id INT,
        friendship_id INT,
        type ENUM('bet_invite', 'bet_accepted', 'bet_declined', 'bet_completed', 'payment_received', 'payment_sent', 'friend_request', 'friend_response') NOT NULL,
    ...
    $db->exec("CREATE TABLE IF NOT EXISTS paymentintents (
        id INT AUTO_INCREMENT PRIMARY KEY,
        bet_id INT NOT NULL,
        user_id INT NOT NULL,
        amount DECIMAL(10,2) NOT NULL,
